...
# Ensure we find the DB relative to the backend root
...
class DevelopmentConfig(Config):
    ...
    DEBUG = True
    ENV = "development"
    # Use instance folder for consistency
    SQLALCHEMY_DATABASE_URI = os.getenv("DATABASE_URL", f"sqlite:///{os.path.join(basedir, 'instance', 'dev.db')}")
